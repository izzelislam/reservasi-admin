...
const AdminFormPage = () => {
  ...
  const {loading, createAdmin, getAdmins, showAdmin, updateAdmin} = useAdminStore()
  ...
  const onsubmit = async (data: z.infer<typeof formSchema>) => {
    try {
      ...
      reset()
      router('/user/admin')
      toast.success("Berhasil menyimpan admin")
    } catch (error:any) {
  ...
  return (
    <Layout>
      <Wrapper title="Admin User" subtitle="buat user admin" back="/user/admin">
