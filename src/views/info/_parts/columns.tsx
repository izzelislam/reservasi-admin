...
export const infoColumns = [
  ...
  columnHelper.accessor('photo_url', {
    header: 'Slug',
    cell: info => <img src={info.getValue()} alt="" className="w-20 h-15 rounded-lg" />
  }),
    ...
    <div className='flex items-center gap-2'>
      <div className="dropdown dropdown-bottom a">
        ...
        <div tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-40 py-4 shadow">
          ...
          <Link to={`/post/info/create/${info.row.original.id}`} className="flex items-center gap-2 cursor-pointer pb-2 border-b border-gray-200">
